...
extension ProductViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        totalItems.append(indexPath.row)
        cell.cellConfiguration(product: prod)
//        cell.favBtn.addTarget(self, action: #selector(buttonClick(sender:)), for: .touchUpInside)
        //let prods = product[indexPath.row]
        
        if favItem[indexPath.row] == true {
